...
BUSINESS RULES:
1. A USER may create any number of PLAYLISTS.
2. Each PLAYLIST must be created by exactly one USER.
3. A PLAYLIST may contain any number of SONGS.
4. Each SONG must belong to exactly one PLAYLIST.
5. A PLAYLIST may have any number of TAGS.6. Each TAG may be used on any number of PLAYLISTS.
7. A USER may like any number of PLAYLISTS.
8. Each LIKE must be made by exactly one USER and must apply to exactly one PLAYLIST.
9. A PLAYLIST may receive any number of LIKES.
10. Each LIKE must belong to exactly one PLAYLIST.
11. A USER may save any number of PLAYLISTS.
12. Each SAVE must be made by exactly one USER and must apply to exactly one PLAYLIST.
13. A PLAYLIST may be saved by any number of USERS.
14. Each SAVE must belong to exactly one PLAYLIST.
15. A USER may repost any number of PLAYLISTS.
